...
public class YamlStorage {
    ...
    public void restore(Player player) {
        ...
        if (file.exists()) {
            ...
            DataManager playerdata = plugin.getPlayerData().getPlayer(player);
            try {
                ConfigurationSection configurationSection = fileConfiguration.getConfigurationSection("collected-rewards");
                if (configurationSection != null) {
                    configurationSection.getKeys(false).forEach(key -> playerdata.setCollectedRewards(key, fileConfiguration.getBoolean("collected-rewards." + key)));
                }
            } catch (Exception e) {
